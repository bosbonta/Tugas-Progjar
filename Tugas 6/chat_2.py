...
class Chat:
	def __init__(self):
		...
		self.sessions={}
		self.users = {}
		self.users['amsal']={ 'nama': 'Amsal Rizky', 'negara': 'Indonesia', 'password': 'jakarta', 'incoming' : {}, 'outgoing': {}}
		self.users['herbert']={ 'nama': 'Herbert Sterling', 'negara': 'Singapura', 'password': 'singapura', 'incoming': {}, 'outgoing': {}}
		self.users['budi']={ 'nama': 'Budi Tanto', 'negara': 'Malaysia', 'password': 'upin-ipin','incoming': {}, 'outgoing':{}}
